...
```bash
git log --all --grep=V11072 --format='%h %cI %s'      # commit thuộc bản này
...
- `CHANGELOG.md` — mục `## V11072`
- `docs/CURRENT_TRUTH_SSOT.md` — mục `### V11072`
- `docs/AUTOMATION_HISTORY.jsonl` — dòng `version=V11072` *(từ `V11062` trở đi)*
