<!-- BẢN VIẾT TAY, CẤT LẠI ngày 17/08/2026 bởi _v11083_sinh_dieu_huong.py -->

# REPORT_INDEX.md — BẢN VIẾT TAY (lưu lại làm lịch sử)

Bản mục lục viết tay, cập nhật lần cuối **27/07/2026**, dừng ở `V10861` — **38 bản** có câu tóm tắt do người viết.

**Vì sao giữ:** nội dung dưới đây có **mô tả do người viết**, không suy ra được từ tên thư mục.
Bản máy sinh thay được phần *mục lục*, **không thay được** phần *nhận định*.

**Bản đang dùng:** `REPORT_INDEX.md` — máy sinh, chạy
`python web/backend/_v11083_sinh_dieu_huong.py`.
