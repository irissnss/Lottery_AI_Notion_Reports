...
**Sinh lúc:** 2026-08-21 20:57:22 (giờ VN) · chỉ mục **còn treo** (bỏ mục đã đóng và luật đứng), cửa sổ **[−14, +21] ngày**
...
| `FU-344` | `DO2108-2` | Ngưỡng FU-284 — ĐÃ ĐĂNG KÝ TRƯỚC | **21/08** | `WAIT_LIVE` |
| `FU-340` | `DO2108` | Đo lại PHẦN 4 khi mẫu ngoài cửa sổ đủ lớn | **21/08** | `WAIT_LIVE` |
| `FU-336` | `KS2108` | Canh cửa sổ đóng băng KHÔNG bị phá lần thứ bảy | **21/08** | `WAIT_LIVE` |
| `FU-337` | `SC2108` | A3 + A4 — hai việc chờ hết đóng băng | **21/08** | `BLOCKED` |
...
| `FU-234` | `DO0905` | B2 đo 105 luật có giúp công bố | **05/09** | `OWNER_LOCK` |
| `FU-285` | `DO0709` | So bản đóng băng với bản học lại — CHẤM HẰNG THÁNG, không chờ một phát | **07/09** | `WAIT_LIVE` |
...
**Báo cáo mới nhất:** `V11098` — FU416 KIEM KE DUYET GOP (2026-08-21)

---

> Bản cũ ghi *«On 28/07, re-read PB-18.1, M2s, K15…»* và đứng nguyên **20 ngày**.
> Việc kế tiếp mà phải nhớ cập nhật tay thì sớm muộn cũng thành việc của tháng trước.
