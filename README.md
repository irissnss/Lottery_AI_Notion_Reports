...
- **V105.6** — SSOT CLEAN + LIVE CRON VERIFY + REGIONAL SOURCE-POOL DATA HEALTH (2026-05-10 12:40 VN): public raw V105.5 evidence was 404 and remote latest was V105.2 before cleanup. V105.6 publishes clean V105.5 evidence, adds dedicated source-pool data-health monitoring, no-token scoreboard, prediction-quality realtime badges, and keeps official hashes unchanged 4/4.

- **V104.1** — PHASE B ACTIVATED + GITHUB PAT ROTATED (2026-05-10 00:15 VN): owner directive "Anh muốn Lane Test chạy thực sự với các thay đổi. Mắc gì sau 7 ngày mới nâng cấp khi 60d evidence đã thấy phù hợp." NEW `web/backend/_v104_phase_b_runner.py` (~370 lines) + 3 thin provider wrappers (Anthropic / OpenAI / Gemini) + scheduler crons 19:24 + 19:30 VN daily. **First real fire 2026-05-10 00:08 VN target_date=2026-05-09**: 9 calls fired, 5 ok, 4 failed, 45 decision rows stored. **MN 13 = ACCEPT HIGH by Claude Opus** ("V67+V70+V73+V101 convergence, test_bt×2, strong pattern match") — exact owner-flagged case caught. MB 64 = REJECT MEDIUM. GitHub PAT rotated VPS-side (FU-V99-TOKEN-LEAK status `OPEN` → `ROTATED`). Hash 4 official tables IDENTICAL pre vs post. ZERO production mutation. 7-day adjustment review 2026-05-17 19:30 VN.
...
- Latest evidence (under `V98_ABSOLUTE_RUNTIME_PUBLIC_NOTION_SYNC_20260509/evidence/`):
  - [V105_6_SSOT_CLEAN_RUNTIME_VERIFY_REPORT.md](https://raw.githubusercontent.com/irissnss/Lottery_AI_Notion_Reports/main/V98_ABSOLUTE_RUNTIME_PUBLIC_NOTION_SYNC_20260509/evidence/V105_6_SSOT_CLEAN_RUNTIME_VERIFY_REPORT.md) ← **V105.6 latest**
  - [V105_5_REGIONAL_SOURCE_POOL_LANE_TEST_REPORT.md](https://raw.githubusercontent.com/irissnss/Lottery_AI_Notion_Reports/main/V98_ABSOLUTE_RUNTIME_PUBLIC_NOTION_SYNC_20260509/evidence/V105_5_REGIONAL_SOURCE_POOL_LANE_TEST_REPORT.md)
  - [CONVERSATION_CONTEXT_V105_5.md](https://raw.githubusercontent.com/irissnss/Lottery_AI_Notion_Reports/main/V98_ABSOLUTE_RUNTIME_PUBLIC_NOTION_SYNC_20260509/evidence/CONVERSATION_CONTEXT_V105_5.md)
  - [V104_1_PHASE_B_ACTIVATED_REPORT.md](https://raw.githubusercontent.com/irissnss/Lottery_AI_Notion_Reports/main/V98_ABSOLUTE_RUNTIME_PUBLIC_NOTION_SYNC_20260509/evidence/V104_1_PHASE_B_ACTIVATED_REPORT.md) ← **V104.1 latest**
...
## V93→V104.1 Quick Index

| Version | Date | Scope | Status |
|---|---|---|---|
| V104.1 | 2026-05-10 | Phase B activated (provider pilot) + GitHub PAT rotated + scheduler crons 19:24/19:30 VN + 45 decision rows + MN 13 ACCEPT HIGH catch | DELIVERED (this release) |
| V104 | 2026-05-09 | Shadow prompt injection per region (Phase A) — 2 shadow tables + 3 region prompts + admin API + UI panel | DELIVERED |
