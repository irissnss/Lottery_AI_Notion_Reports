...
```bash
git log --all --grep=V11066 --format='%h %cI %s'      # commit thuộc bản này
...
- `CHANGELOG.md` — mục `## V11066`
- `docs/CURRENT_TRUTH_SSOT.md` — mục `### V11066`
- `docs/AUTOMATION_HISTORY.jsonl` — dòng `version=V11066` *(từ `V11062` trở đi)*
