...
```bash
git log --all --grep=V11067 --format='%h %cI %s'      # commit thuộc bản này
...
- `CHANGELOG.md` — mục `## V11067`
- `docs/CURRENT_TRUTH_SSOT.md` — mục `### V11067`
- `docs/AUTOMATION_HISTORY.jsonl` — dòng `version=V11067` *(từ `V11062` trở đi)*
