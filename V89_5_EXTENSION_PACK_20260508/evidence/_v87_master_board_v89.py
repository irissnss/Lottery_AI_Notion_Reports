...
def build_payload() -> dict[str, Any]:
    """Return the full V87+V88+V89 master board payload. READ-ONLY."""
    c = _conn()
    return {
        "schema_version": "v89_master_board_v3",
        ...
        "owner_controls": {
            ...
            "note": "V87+V88+V89 Master Index cố ý không có nút điều khiển. Mọi thay đổi đều cần owner OK ở session riêng + dossier.",
        },
    }
