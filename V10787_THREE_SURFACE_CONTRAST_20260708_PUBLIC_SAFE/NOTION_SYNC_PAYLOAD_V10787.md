...
**Quyết định chờ ký:** K8 gemma MB 429 (K8a slim-context / K8b nâng tier / K8c chấp nhận) · **K9 HERD_FADE_V1** (mới) · **K10 ML_BLOC_DEDUP_V1** (mới). Nhắc: CP-L5 hard deadline 09/07 (ngày mai).
