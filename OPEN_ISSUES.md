# Open Issues — V105.32 safe continuation (2026-05-12 12:18 VN)

Latest public truth: V105.32 is a safe-continuation wrapper on top of V105.31. It does not change official prediction policy. At the 12:09 VN live sync, MN remains clean (`official=15/15`, `shadow=13/13`, `missing_shadow=[]`, `glm-5.1` diagnostic empty due `finish_reason=length`), while MT/MB are still `NATURAL_VERIFY_PENDING`.

## V105.32 / V105.31 active issues
...
- `FU-V105-30D-SHADOW-NO-MISSING-CONTRACT`: **DEPLOYED_PENDING_FULL_NATURAL_VERIFY** — V105.30d scheduler/database hardening deployed. MN 2026-05-12 proves shadow `13/13`, `missing_shadow=[]`; `glm-5.1` diagnostic empty row is valid non-timeout diagnostic, not missing. MT/MB natural-cycle verification remains pending at the 12:09 VN snapshot.
