...
```bash
git log --all --grep=V11073 --format='%h %cI %s'      # commit thuộc bản này
...
- `CHANGELOG.md` — mục `## V11073`
- `docs/CURRENT_TRUTH_SSOT.md` — mục `### V11073`
- `docs/AUTOMATION_HISTORY.jsonl` — dòng `version=V11073` *(từ `V11062` trở đi)*
