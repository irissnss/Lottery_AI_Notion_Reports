...
```bash
git log --all --grep=V11074 --format='%h %cI %s'      # commit thuộc bản này
...
- `CHANGELOG.md` — mục `## V11074`
- `docs/CURRENT_TRUTH_SSOT.md` — mục `### V11074`
- `docs/AUTOMATION_HISTORY.jsonl` — dòng `version=V11074` *(từ `V11062` trở đi)*
