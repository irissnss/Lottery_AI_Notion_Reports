...
# V10636 MB MB_COST_CONTROL_LANE_V1 EXECUTION (dry-run, artifact-only)

- ts_vn: `2026-05-27T23:03:25`
- date: `2026-05-27` (today_weekday=2)
- rules_eligible_today: 0
- tail_pool_size: 0 (cap max_pool=8)
- dampeners_applied: []
...
- lane_bt: `None`
- lane_lo2: `[]`
- official_bt: `08` status `LOSE`
- lane_bt_same_as_official: 0 | hit_db: 0 | hit_full: 0
- actual_tails_db: ['13', '45']
